...
<html>
<head>
    <title>Crop Registration and Login</title>
    <style>
        body {
...
<div class="form-container">
    <form id="registration-form" action="register.php" method="post" class="show">
        <h1>Registration</h1>
    ...
    <form id="login-form" action="inventory.php" method="post">
        <h1>Login</h1>
        <input type="email" name="email" placeholder="Email" required>
        <input type="password" name="password" placeholder="Password" required>
